...
const AnalysisResult = () => {
    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-slate-950 text-white">
        <div className="flex flex-col items-center">
          ...
          <span className="mt-4 text-slate-400 text-sm font-semibold tracking-wider">RETRIEVING REPORT...</span>
        </div>
      </div>
    );
  }
  ...
  if (error || !analysis) {
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-slate-950 px-4">
        <div className="text-center border border-slate-800 bg-slate-900/20 max-w-md p-8 rounded-xl backdrop-blur-md">
          <AlertCircle className="h-12 w-12 text-rose-500 mx-auto mb-4" />
          <h3 className="text-lg font-bold text-white mb-2">Error Loading Report</h3>
          <p className="text-sm text-slate-400 mb-6">{error || 'Analysis report could not be found.'}</p>
          <Link
            to="/history"
            className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 border border-slate-800 hover:border-slate-700 px-4 py-2 text-sm font-semibold text-white transition-all duration-200"
          >
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-slate-950 text-slate-100 py-10 px-4 sm:px-6 lg:px-8 relative animate-fade-in">
      ...
      <div className="mx-auto max-w-7xl relative space-y-8">
        ...
        <div className="flex flex-col gap-4 border-b border-slate-800 pb-6">
          <Link to="/history" className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-400 hover:text-white transition-colors w-fit">
